...
const {uploadPostPage, uploadFile, postPreviewPage, postComments, deleteComment, searchPage, followUser, test, assignNotif, unfollowUser, admin, registerPost, logout, changeCredentials, mainPage, login, register, profile, verifyUser, loginPost, notifPage, deletePost, chatRoom, addChat} = require("../controllers/posts.js")
