...
const {uploadPostPage, uploadFile, postPreviewPage, postComments, deleteComment, searchPage, followUser, test, assignNotif, unfollowUser, admin, registerPost, logout, changeCredentials, mainPage, login, register, profile,settings, verifyUser, loginPost, notifPage, deletePost, chatRoom, chatPage, getChatMembers, checkIfUserExistsRoute, getUserApi, getLikes, addLike, removeLike} = require("../controllers/posts.js")
